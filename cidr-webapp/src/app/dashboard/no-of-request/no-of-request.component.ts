...
@Component({
  selector: 'app-no-of-request',
  templateUrl: './no-of-request.component.html',
  styleUrls: ['./no-of-request.component.css']
})
export class NoOfRequestComponent extends Listing implements OnInit {
data: any;
values: any;
reportType: any;
userDetails: any;
...
constructor(
  ...
  getReport() {
    var data = {
      ...
      driverId: this.driver ? this.driverId : ''
    }
  ...
  driverChange(driverId) {
    if (driverId && driverId != "0") {
      ...
      this.fromdate = new Date();
      this.todate = new Date();
      // this.isDisableReportType=false;
    }
    this.getReport();
  }
