...
import {
  riderAdminList, updateShuttleStatus,nearByPickupPoints, nearByDropOffPoints, driverRoutes,getCurrentTripOrRequest,driverHistory,ridesCompletingAtTerminal,getRiderNotificationRequests,driverCurrentFromTerminals,driverCurrentToTerminals,driverAddRider,driverAddDynamicRider
...
router
  ...
  .get(driverCurrentToTerminals)
   ...
   /**api/users/location/driverCurrentToTerminals */
   router
   .route('/location/driverAddDynamicRider')
   .post(driverAddDynamicRider)
