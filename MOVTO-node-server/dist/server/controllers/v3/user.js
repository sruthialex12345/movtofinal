...
exports.riderAdminList = exports.driverAddRider = exports.driverCurrentToTerminals = exports.driverCurrentFromTerminals = exports.ridesCompletingAtTerminal = exports.driverHistory = exports.nearByDropOffPoints = exports.nearByPickupPoints = exports.regenerateAccessCode = exports.updateShuttleStatus = undefined;
...
var updateShuttleStatus = exports.updateShuttleStatus = function updateShuttleStatus(req, res, next) {
  ...
  console.log("gpsLoc to activate>>>>>>>>>>", (0, _stringify2.default)(req.body));
  var tripGpsLoc = req.body.gpsLoc;

  if ((!tripGpsLoc || tripGpsLoc == null || !Array.isArray(tripGpsLoc) || !tripGpsLoc.length) && activeStatus == 'true') {
    returnObj.message = "GPS location not found";
              ...
              _adminVehicle2.default.findOne({ '_id': shuttleId, activeStatus: false, isDeleted: false, isAvailable: true }).then(function (vehicleDetails) {
                if (vehicleDetails) {
                  var tripUpdateData = {
                    ...
                    driver: driver,
                    gpsLoc: tripGpsLoc || driver.gpsLoc,
                    activeStatus: true,
...
var regenerateAccessCode = exports.regenerateAccessCode = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(req, res, next) {
    var returnObj, user, userId, err, userToUpdate, newAccessCode, savedUser, activeTrip, deactivateResult;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            console.log("userTypes >>>>>>>", user.userType, _userTypes.USER_TYPE_ADMIN);

            if (user.userType == _userTypes.USER_TYPE_ADMIN || user.userType == USER_TYPE_SUPER_ADMIN) {
              _context.next = 10;
              break;
            }

            err = new _APIError2.default('Unauthorized', _httpStatus2.default.UNAUTHORIZED);
            return _context.abrupt('return', next(err));

          case 10:
            _context.prev = 10;
            _context.next = 13;
            return _user2.default.findOneAsync({ _id: userId });
          ...
          case 19:
            ...
            returnObj.message = "User was deleted";
            return _context.abrupt('return', res.send(returnObj));

          case 22:
            newAccessCode = _util2.default.generateAccessCode();

            userToUpdate.accessCode = newAccessCode;
            userToUpdate.accessCodeVerified = false;
            savedUser = userToUpdate.saveAsync();
          ...
          case 29:
            ...
            returnObj.success = true;
            returnObj.message = "Access code updated";

            if (!(userToUpdate && userToUpdate.userType == _userTypes.USER_TYPE_DRIVER)) {
              _context.next = 40;
              break;
            }

            _context.next = 34;
            return _trip2.default.findOneAsync({ "driver._id": userToUpdate._id, activeStatus: true });

          case 34:
            activeTrip = _context.sent;
            ...
            _context.next = 38;
            return deactivateTripAsync(activeTrip._id);

          case 38:
            deactivateResult = _context.sent;

            if (!deactivateResult.success) {
              returnObj.success = false;
              returnObj.message = deactivateResult.message;
            }
    ...
    }, _callee, undefined, [[10, 43]]);
  }));

  return function regenerateAccessCode(_x, _x2, _x3) {
...
function deactivateTripAsync(tripId) {
  ...
  console.log("tripId to deactivate", tripId);

  return new _promise2.default(function () {
    var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(resolve, reject) {
      var returnObj, trip, driverId, shuttleId, promises, result, driver, vehicle, tripRequestStatuses, pipelineStages, acceptedRequests, response, allRequestsToUpdate, updateRequestsAsync, updatedReqs, transferToShuttle, eventPayload;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              returnObj.message = "Invalid trip Id";
              return _context2.abrupt('return', resolve(returnObj));

            case 4:
              _context2.prev = 4;
              _context2.next = 7;
              return _trip2.default.findOneAsync({ _id: tripId });
            ...
            case 11:
              driverId = trip.driver && trip.driver._id;
              shuttleId = trip.shuttleId;
              promises = [_user2.default.findOneAsync({ _id: driverId, isDeleted: false }, { password: 0 }), _adminVehicle2.default.findOneAsync({ _id: shuttleId })];
              _context2.next = 16;
            ...
            case 16:
              ...
              console.log("userAdminResult>>>>>>>>", (0, _stringify2.default)(result));
            ...
            case 31:
              ...
              tripRequestStatuses = [TRIP_REQUEST_STATUS.TRIP_REQUEST_INIT, TRIP_REQUEST_STATUS.TRIP_REQUEST_ENROUTE, TRIP_REQUEST_STATUS.TRIP_REQUEST_ACCEPTED];
              pipelineStages = [{
                $match: {
              ...
              _context2.next = 36;
              return _tripRequest2.default.aggregateAsync(pipelineStages);

            case 36:
              acceptedRequests = _context2.sent;
              ...
              _context2.next = 40;
              return nearByShuttleAsync(tripId, { seats: acceptedRequests[0].seats });
            ...
            case 40:
              ...
              allRequestsToUpdate = acceptedRequests[0].requests;
              updateRequestsAsync = allRequestsToUpdate.map(function (req, index) {
                return rejectTripRequestNotifyRiderAsync(trip, req);
              });
              _context2.next = 46;
              return _promise2.default.all(updateRequestsAsync);

            case 46:
              updatedReqs = _context2.sent;
              ...
              console.log("all requests rejected and riders notified");
              _trip2.default.findOneAndUpdateAsync({ _id: tripId, activeStatus: true }, { $set: {
                  activeStatus: false, tripEndTime: new Date().toISOString(),
                  visitedTerminalIds: [], visitedTerminalsCount: 0
                } }, { new: true }).then(function (updatedTrip) {
                updateDriverVehicleStatusAsync(updatedTrip, updatedTrip.shuttleId, false).then(function (results) {
            ...
            case 52:
              console.log("something went wrong rejecting reqs >>>>>>>>", updatedReqs);
              return _context2.abrupt('return', reject(new Error("something went wrong")));
            ...
            case 56:
              // notify the driver on other trip, to request to transfer of all pending requests
              transferToShuttle = response && response.data && response.data[0];
              ...
              if (trip.driver.tripType == _tripType.TRIP_DYNAMIC) {
                ...
                // send request to the other trip driver
                eventPayload = { success: true, message: "New transfer request", data: { tripId: tripId } };

                _socketStore2.default.emitByUserId(transferToShuttle.driver._id, 'transferRequest', eventPayload);

                transferRequestsAsync(tripId, transferToShuttle._id).then(function (result) {
                  _trip2.default.findOneAndUpdateAsync({ _id: tripId, activeStatus: true }, { $set: {
                      activeStatus: false, tripEndTime: new Date().toISOString(), transferredTo: transferToShuttle._id,
                      visitedTerminalIds: [], visitedTerminalsCount: 0
                    } }, { new: true }).then(function (updatedTrip) {
...
var riderAdminList = exports.riderAdminList = function riderAdminList(req, res, next) {
  ...
  var pipelineStages = [{
    ...
    $project: { 'name': 1, tripType: 1, reservationCode: 1, profileUrl: 1, adminTripTypes: 1 }
