...
class Maps extends Component {
  ...
  fitMaptoCordinations = (coordinates, region) => {
    if ((coordinates.length || (region && region.latitude)) && this.map) {
