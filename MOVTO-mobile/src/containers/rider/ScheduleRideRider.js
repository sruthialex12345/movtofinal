...
class ScheduleRideRider extends Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      countryCode: this.props.user ? this.props.user.countryCode : "IN",
      // cca2: "IN",
      country: this.props.user ? this.props.user.country : "India",
      isdCode: this.props.user ? this.props.user.isdCode : "91",
  ...
  moveToNextStep = _.debounce(() => {
    let { navigator, requestId, updateTrip, riderLocation } = this.props;
    ...
    if (destination && source && noOfPersons) {
      ...
      let postData = {
        ...
        isdCode,
        name,
        adminId: riderLocation.userProvider._id,
        countryCode,
        country
      };
      ...
      this.props.appActions.scheduleRideRider(postData, navigator);
    }
  }, 500);
      ...
      <View style={Styles.container}>
        ...
        <View style={btnView}>
          ...
          <AuthButton
            ...
            textStyle={{ color: "#fff" }}
            loading={riderTrip.scheduleNewTripLoader}
          />
        </View>
        <DatePicker
