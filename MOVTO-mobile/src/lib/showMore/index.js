  ...
  render() {
    return (
      <View style={this.getWrapperStyle()}>
        <View style={{ flexDirection: "row" }} onLayout={this.onLayoutTrimmedText}>
          <Text style={[this.props.textStyle, this.props.newStyle]} numberOfLines={this.state.numberOfLines}>
            {this.props.children}
          </Text>
          {this.renderFooter()}
        </View>
